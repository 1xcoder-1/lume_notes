...
/**
 * A custom-built Switch component that doesn't rely on external Radix UI primitives.
 * This ensures the build passes without needing a fresh npm/pnpm install.
 */
