...
export async function sendVerificationEmail(email: string, token: string) {
  ...
  const content = `
    ...
    <p>Thank you for creating an account with lume notes. To complete your registration, please verify your email address.</p>
  ...
  return sendEmail({
    to: email,
    subject: "Verify your lume notes account",
    htmlContent,
...
export async function sendPasswordResetEmail(email: string, token: string) {
  ...
  const content = `
    ...
    <p>We received a request to reset the password for your lume notes account. If you made this request, click the button below to create a new password.</p>
  ...
  return sendEmail({
    to: email,
    subject: "Reset your lume notes password",
    htmlContent,
...
export async function sendOrganizationInviteEmail(
  ...
  const content = `
    ...
    <p><strong>${inviterName}</strong> has invited you to join their team on lume notes.</p>
    <p>lume notes is a collaborative note-taking platform that helps teams organize their thoughts, share knowledge, and work together more effectively.</p>

    <div style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; padding: 20px; margin: 20px 0;">
      <h3 style="color: #0369a1; margin-bottom: 8px;">What you can do with lume notes:</h3>
  ...
  return sendEmail({
    to: email,
    subject: `Join ${organizationName} on lume notes`,
    htmlContent,
